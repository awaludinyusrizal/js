        ...
        function t(i, e, s, h, o, a, _, u, c) {
          for (
            !(function (t, i) {
              ...
              this._traceLength = c,
              this._totalDistance = n(this._sx, this._sy, this._dx, this._dy);
            this._traceLength--;
              ...
              value: function () {
                ...
                this._ctx.beginPath(),
                  ...
                  (this._ctx.strokeStyle =
                    "hsl(" + this._hue + ", 100%, " + this._brightness + "%)"),
                  this._ctx.stroke();
              },
            },
          ]) && o(i.prototype, e),
      ...
      var l = (function () {
        function t(i) {
          ...
          !(function (t, i) {
            ...
            (this._boundaries = { top: 50, bottom: 0, left: 50, right: 0 }),
            (this._sound = {
              enable: !1,
            ...
            (this._friction = i.friction || 0.95),
            ...
            (this._autoresize =
              null === (e = i.autoresize) || void 0 === e || e),
            (this._boundaries = Object.assign(
              Object.assign({}, this._boundaries),
              i.boundaries
            )),
            (this._sound = Object.assign(
              Object.assign({}, this._sound),
              i.sound
            )),
            this._autoresize &&
            ...
            },
            {
              ...
              value: function () {
                ...
                (this._width = e),
                  ...
                  this.updateBoundaries({ right: e, bottom: n });
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this._ctx && this._running) {
                  ...
                  this._tick > 2 * this._startDelay &&
                    (this._fireworks.push(
                      new a(
                        0.5 * this._width,
                        this._height,
                        r(this._boundaries.left, this._boundaries.right - 50),
                        r(this._boundaries.top, 0.5 * this._boundaries.bottom),
                        this._ctx,
                        this._hue,
                        this._speed,
                        this._acceleration,
